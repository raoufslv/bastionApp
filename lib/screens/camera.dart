          ...
          children: [
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => GallerieP(
                                  mediaPaths: mediaPaths, indexo: index),
                            ),
                          );
                        },
                        child: Hero(
            ...
            Positioned(
              ...
              child: ElevatedButton(
                ...
                child: const Icon(Icons.camera_alt, color: Colors.brown),
              ),
            ),
          ],
        ),
...
class GallerieP extends StatefulWidget {
  const GallerieP({super.key, required this.mediaPaths, required this.indexo});
  final List<String> mediaPaths;
  final int indexo;

  @override
  State<GallerieP> createState() => _GallerieState();
}

class _GallerieState extends State<GallerieP> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PhotoViewGallery.builder(
        ...
        builder: (context, index) {
          ...
          return PhotoViewGalleryPageOptions.customChild(
            ...
            child: mediaPath.endsWith('.mp4')
                ? FullscreenVideoScreen(videoPath: mediaPath)
                : Image.file(
                    File(mediaPath),
                    fit: BoxFit.contain,
                  ),
            heroAttributes: PhotoViewHeroAttributes(tag: mediaPath),
          );
        },
        ...
        pageController: PageController(initialPage: widget.indexo),
        onPageChanged: (index) {
